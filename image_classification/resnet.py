# From https://github.com/MinaGhadimiAtigh/Hyperbolic-Busemann-Learning
#
...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, output_dims=10, multiplier=1, polars=None, device="cpu"):
    ...
    def predict(self, x):
        ...
        x = torch.mm(x, self.polars.t().to(self.device))
        return x
