## From https://github.com/joeybose/HyperbolicNF/blob/master/utils/hyperbolics.py
...
from .math_ops import clamp, acosh, cosh, sinh, sqrt, logsinh, e_i, expand_proj_dims
